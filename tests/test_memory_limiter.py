...
custom_strategies = [
    RateLimitStrategy(name=RateLimitStrategyName.SHORT, limit=2, ttl=30),     # 2/30sec for testing
...
async def get_data():
    ...
    return {"data": "This endpoint uses default rate limiting", "timestamp": "2024-01-01T00:00:00Z"}
